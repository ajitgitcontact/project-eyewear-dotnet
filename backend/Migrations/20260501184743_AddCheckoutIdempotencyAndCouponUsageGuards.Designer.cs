...
namespace backend.Migrations
{
    ...
    [Migration("20260501184743_AddCheckoutIdempotencyAndCouponUsageGuards")]
    partial class AddCheckoutIdempotencyAndCouponUsageGuards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Carts.Cart", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.Carts.CartCoupon", b =>
                {
                    b.Property<string>("CartCouponId")
                        .HasColumnType("varchar");
                    ...
                    b.ToTable("CartCoupons", null, t =>
                        {
                            t.HasCheckConstraint("CK_CartCoupons_CouponDiscountAmount_NonNegative", "\"CouponDiscountAmount\" >= 0");
                        });
                });

            modelBuilder.Entity("backend.Models.Carts.CartItem", b =>
                {
                    ...
                    b.ToTable("CartItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_CartItems_FinalUnitPrice_NonNegative", "\"FinalUnitPrice\" >= 0");

                            t.HasCheckConstraint("CK_CartItems_LineTotal_NonNegative", "\"LineTotal\" >= 0");

                            t.HasCheckConstraint("CK_CartItems_ProductDiscountAmount_NonNegative", "\"ProductDiscountAmount\" >= 0");
            ...
            modelBuilder.Entity("backend.Models.Carts.CartItemCustomization", b =>
                {
                    b.Property<string>("CartItemCustomizationId")
                        .HasColumnType("varchar");
                    ...
                    b.Property<string>("CustomizationValue")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.HasKey("CartItemCustomizationId");
            ...
            modelBuilder.Entity("backend.Models.Carts.CartItemPrescription", b =>
                {
                    b.Property<string>("CartItemPrescriptionId")
                        .HasColumnType("varchar");
                    ...
                    b.HasKey("CartItemPrescriptionId");

                    b.HasIndex("CartItemId")
                        .IsUnique();

                    b.HasIndex("CustomerPrescriptionsId");

                    b.HasIndex("UserId");

                    b.ToTable("CartItemPrescriptions");
                });
            ...
            modelBuilder.Entity("backend.Models.Orders.CouponUsage", b =>
                {
                    ...
                    b.HasIndex("CouponId", "CustomerOrderId")
                        .IsUnique();
            ...
            modelBuilder.Entity("backend.Models.Wishlists.Wishlist", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.Wishlists.WishlistItem", b =>
                {
            ...
            modelBuilder.Entity("backend.Models.Carts.CartCoupon", b =>
                {
                    b.HasOne("backend.Models.Carts.Cart", "Cart")
            ...
            modelBuilder.Entity("backend.Models.Carts.CartItemCustomization", b =>
                {
                    b.HasOne("backend.Models.Carts.CartItem", "CartItem")
                    ...
                    b.HasOne("backend.Models.Products.CustomizationValue", "CustomizationValueEntity")
                        .WithMany()
                    ...
                    b.Navigation("CustomizationValueEntity");
                });
            ...
            modelBuilder.Entity("backend.Models.Carts.CartItemPrescription", b =>
                {
                    b.HasOne("backend.Models.Carts.CartItem", "CartItem")
                        ...
                        .HasForeignKey("backend.Models.Carts.CartItemPrescription", "CartItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend.Models.Orders.CustomerPrescription", "CustomerPrescription")
                        .WithMany()
                        .HasForeignKey("CustomerPrescriptionsId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("CustomerPrescription");
            ...
            modelBuilder.Entity("backend.Models.Wishlists.WishlistItem", b =>
                {
                    ...
                    b.HasOne("backend.Models.Wishlists.Wishlist", "Wishlist")
